...
# 训练
trainer_1 = model_trainer(sub_smile=sub_smiles, model="model_0822", binmols=binmols)
trainer_1.init_model(dataset_info)
trainer_1.fit()
trainer_1.save_model("models/model_0822")
...
generator_1.dump("datasets/generator_0822_m.pickle", "datasets/generator_0822_p.pickle")
