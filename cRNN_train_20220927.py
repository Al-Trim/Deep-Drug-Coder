...
descrs_1_list = []
for i in range(4):
    generator.load_data("datasets/generator_0925_{}.pickle".format(i))
    ...
    binmols_1_list.append(new_binmols[-2000:])
    descrs_1_list.append(new_descrs[-2000:])
...
for i in range(4,8):
    ...
    if i == 0:
        ...
        #重新训练
        trainer = model_trainer(sub_smile=sub_smiles, model="model_0927", binmols=binmols, descrs=descrs)
        ...
        generator.dump("datasets/generator_0924_{}.pickle".format(i), generator.sani_properties)
    ...
    del binmols_list[-2]
    del descrs_list[-2]
    binmols_list.insert(0, filtered_binmols[-2000:])
    descrs_list.insert(0, filtered_descrs[-2000:])
    binmols = np.concatenate(binmols_list)
