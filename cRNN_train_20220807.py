...
with h5py.File(dataset_filename, "r") as f:
    binmols_1 = np.asarray(f["mols"][500000:510000])
...
binmols = np.concatenate((binmols_1, binmols_2))
#binmols = np.concatenate((binmols_3, binmols_3))
...
maxlen = 128
# Name of the dataset
name = "ChEMBL25_TRAIN_FILTERED_2"
...
model.fit(epochs              = 300,         # number of epochs
          ...
          model_name          = "model_0807", # base name to append the checkpoints with
          checkpoint_dir      = "checkpoints_0807/",          # save checkpoints in the notebook's directory
