...
binmols = np.asarray(binmols_1)
descrs = np.asarray(descrs_1)
...
gt.fit(model_name='model_1114_retrain_0', epochs=100, lr=pow(10,-3), lr_init=pow(10,-4.5))
gt.save_model("models/model_1114_retrain_0")
...
gt.plot("results/model_1114_retrain_{}.png".format(0), title="model_1114_pretrain")
...
report_data.to_csv('results/report_1114.csv')
