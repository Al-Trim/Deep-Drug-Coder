...
for i in range(4):
    ...
    #重新训练
    if i == 0:
        #trainer = model_trainer(is_retrain=True, sub_smile=sub_smiles, model="models/model_0917_0", binmols=binmols, descrs=descrs)
        #trainer.init_model(dataset_info)
        generator = mol_generator(seed_smile=seed_smiles, sub_smile=sub_smiles, model="models/model_0917_0", target_names=target_names)
        generator.load_data("datasets/generator_0917_m_0.pickle", "datasets/generator_0917_p-gasas_0.pickle")
    else:
        trainer = model_trainer(is_retrain=True, sub_smile=sub_smiles, model=generator.model, binmols=binmols, descrs=descrs)
    trainer.fit()
    trainer.save_model("models/model_0917_{}".format(i))
    ...
    generator.dump("datasets/generator_0917_m_{}.pickle".format(i), generator.sani_mols)
    generator.dump("datasets/generator_0917_p-gasas_{}.pickle".format(i), generator.sani_properties)
    ...
    dataset_filename = r"datasets/data_0917_{}.h5".format(i)
