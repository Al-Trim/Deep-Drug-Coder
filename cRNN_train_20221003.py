...
# 合并
binmols_list =  [binmols_2, binmols_3]
descrs_list = [descrs_2, descrs_3]
...
for i in range(4):
    ...
    #重新训练
    trainer = model_trainer(sub_smile=sub_smiles, model="model_1003", binmols=binmols, descrs=descrs)
    trainer.init_model(dataset_info)
    trainer.fit(lr_init=pow(10, -4.5))
    trainer.save_model("models/model_1003_{}".format(i))
    ...
    generator.dump("datasets/generator_1003_{}.pickle".format(i), generator.sani_properties)
