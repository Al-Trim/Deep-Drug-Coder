...
for i in range(4):
    ...
    gt.fit(model_name='model_1028_{}'.format(i), lr_init=pow(10,-4.5))
    gt.save_model("models/model_1028_{}".format(i))
    ...
    gt.dump("datasets/generator_1028_{}.pickle".format(i), gt.sani_properties)
    sani_properties_list.append(gt.sani_properties.copy())
    gt.plot("results/model_1028_{}.png".format(i), title="model_1028_{}".format(i))
...
gt.init_model(x=descrs, y=binmols, dataset_info=dataset_info)
gt.fit(model_name='model_1028_retrain_0', lr=pow(10,-4.5), lr_init=pow(10,-4.5))
gt.save_model("models/model_1028_retrain_0")
...
for i in range(4):
    ...
    #重训
    gt.retrain("models/model_1028_retrain_{}".format(i), x=descrs, y=binmols, lr=pow(10,-4.5), lr_init=pow(10,-4.5))
    gt.save_model("models/model_1028_retrain_{}".format(i+1))
    ...
    properties = get_descriptors(mols, sub_mol)
    gt.set_properties(properties)
    gt.plot("results/model_1028_retrain_{}.png".format(i), title="model_1028_retrain_{}".format(i))
...
report_data.to_csv('results/report_1028.csv')
