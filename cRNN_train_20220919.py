...
# 公用变量
target_names = ["logp", "tpsa", "sub_similarity", "qed", "hba", "hbd", "gasas", "molwt"]      
...
for i in range(4):
    ...
    #重新训练
    trainer = model_trainer(sub_smile=sub_smiles, model="models/model_0919", binmols=binmols, descrs=descrs)
    trainer.init_model(dataset_info)
    trainer.fit()
    trainer.save_model("models/model_0919_{}".format(i))
    ...
    generator.dump("datasets/generator_0919_m_{}.pickle".format(i), generator.sani_mols)
    generator.dump("datasets/generator_0919_p-gasas_{}.pickle".format(i), generator.sani_properties)
    ...
    dataset_filename = r"datasets/data_0919_{}.h5".format(i)
